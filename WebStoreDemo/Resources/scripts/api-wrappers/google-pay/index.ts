export class GooglePayPayment {
    ...
    public canMakePayments(): boolean { return this.integration.googlePayEnabled; }
    ...
    public startPayment(paymentInfo: PaymentInfo,
        ...
        const supportedPaymentMethods:PaymentMethodData[] = [{
            ...
            data: {
                environment: contextThis.integration.googlePayConfiguration.environment,
                apiVersion: contextThis.integration.googlePayConfiguration.apiVersion,
                allowedPaymentMethods: ['CARD', 'TOKENIZED_CARD'],
                paymentMethodTokenizationParameters: {
                    tokenizationType: 'PAYMENT_GATEWAY',
                    parameters: {
                        'gateway': contextThis.integration.googlePayConfiguration.gateway,
                        'gatewayMerchantId': contextThis.integration.googlePayConfiguration.gatewayMerchantId
                    },
                    cardRequirements: {
                        allowedCardNetworks: contextThis.integration.schemes
                    }
                }
            }
        }];
